...
OUTPUT="./ckpts/star_qa_imgx{$NUM_FRAMES}_Query_Video_vila3b_loss2"
...
##DATA_SELECT="star_qa_imgx4_Query_Program_Graph_Image"
##OUTPUT="./ckpts/star_qa_imgx4_Query_Program_Graph_Image_vila3b_loss2"
##
##MODEL_BASE=Efficient-Large-Model/VILA1.5-3B
### Final output checkpoint path
##
...
##
##
##DATA_SELECT="star_qa_imgx4_Query_Program_Image"
##OUTPUT="./ckpts/star_qa_imgx4_Query_Program_Image_vila3b_loss2"
##
##MODEL_BASE=Efficient-Large-Model/VILA1.5-3B
### Final output checkpoint path
##
...
##OUTPUT="./ckpts/star_qa_imgx4_Program_Graph_vila3b_loss2"
##
##MODEL_BASE=Efficient-Large-Model/VILA1.5-3B
### Final output checkpoint path
##
...
##OUTPUT="./ckpts/star_qa_imgx4_Query_Graph_vila3b_loss2"
##
##MODEL_BASE=Efficient-Large-Model/VILA1.5-3B
### Final output checkpoint path
##
