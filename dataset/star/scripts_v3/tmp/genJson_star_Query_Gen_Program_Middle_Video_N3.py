...
def format_into_instruct(sample, image_used, qid_to_frames, 
    ...
    from_human_0 = "<video>\n" + "STAR Task: {} Select from options: {}. Program: ".format(question, options)
    from_gpt_0   = program_structured

    from_human_1 = " Select from options: " + options
...
def main():
    ...
    for input_json in input_json_s:
        output =  get_output_name(base_folder, input_json, image_used, random_order, reverse_order, "Query_Gen_Program_Middle_Video_v3.0")
