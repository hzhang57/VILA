...
def convert_program_v7(program, program_middle):
    ...
    program_structured = remove_whitespace_in_brackets(exe_stack[-1])
...
def main():
    ...
    for input_json in input_json_s:
        output =  get_output_name(base_folder, input_json, image_used, random_order, reverse_order, "Query_Gen_Program_Middle_Video_3Stage_v3.0")
