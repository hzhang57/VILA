...
def format_into_instruct(sample, image_used, qid_to_frames, 
    ...
    from_human_0 = "<video>\n" + "{}\n{}\nSelect from options: {}".format(question, program_structured, options)
...
def main():
    ...
    for input_json in input_json_s:
        output =  get_output_name(base_folder, input_json, image_used, random_order, reverse_order, "Query_Program_Video_v3.0")
